...
let s:alt_fg_text             = [ '231', '245',          '', '#ffffff', '#737070',          '' ]
...
let s:alt_bg_text_none        = [ '254', '232',      'none', '#e4e4e4', '',             'none' ]
...
let s:green_fg_text           = [ '231',  '34',          '', '',        '#00af00',          '' ]
...
call <sid>PaigeHighlight('String',      s:blue_fg_text)
call <sid>PaigeHighlight('Character',   s:alt_fg_text)
call <sid>PaigeHighlight('Number',      s:alt_fg_text)
call <sid>PaigeHighlight('Boolean',     s:alt_fg_text)
call <sid>PaigeHighlight('Float',       s:alt_fg_text)
...
" ALE
call <sid>PaigeHighlight('ALEError',       s:red_bg_text)
call <sid>PaigeHighlight('ALEErrorSign',   s:red_bg_text)
call <sid>PaigeHighlight('ALEWarning',     s:green_bg_text)
call <sid>PaigeHighlight('ALEWarningSign', s:green_bg_text)
