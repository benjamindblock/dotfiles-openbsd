...
highlight MatchHTML guifg        = NONE    guibg=#4C4C4C cterm=NONE
...
highlight StatusLine guifg       = #DDE1DE guibg=#5f5f5f cterm=bold
highlight StatusLineNC guifg     = darkgrey guibg=#5f5f5f cterm=NONE
...
highlight LineNr term=none ctermfg=58 ctermbg=none guifg=#6e6e00 guibg=bg
highlight MatchParen ctermfg=none ctermbg=238 guibg=#4e4e4e
highlight Pmenu guifg            = NONE guibg=#5f5f5f cterm=NONE
highlight PmenuSel guifg         = NONE guibg=#4e4e4e cterm=NONE
highlight PmenuSbar guifg        = #4e4e4e guibg=#4e4e4e cterm=NONE
highlight PmenuThumb guifg        = #4e4e4e guibg=#4e4e4e cterm=NONE
highlight IncSearch guifg        = #303030 guibg=#ffd75f cterm=NONE
highlight Search guifg           = #e4e4e4 guibg=#5f87af cterm=bold
